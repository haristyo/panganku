...
<div class="bg-light border-right" id="sidebar-wrapper">
  <div class="list-group list-group-flush">
    <a href="" class="list-group-item list-group-item-action bg-light"><br></a>
    <a href="<?= base_url('dashboard/')?>" class="list-group-item list-group-item-action bg-light">Statistik</a>
